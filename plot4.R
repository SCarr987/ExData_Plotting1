...
plot(dataSet$Time, dataSet$Global_active_power,type='l',ylab="Global Active Power", xlab="")
...
plot(dataSet$Time, dataSet$Global_reactive_power,type='l', ylab="Global_reactive_power",xlab="datetime" )
# save to .png
